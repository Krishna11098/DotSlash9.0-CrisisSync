...
const Beam = ({
  ...
  // Varied colors: purple, teal, green, orange, pink
  const colors = [
    { h: 280, s: 65, l: 60 }, // Purple
    { h: 175, s: 60, l: 55 }, // Teal
    { h: 160, s: 55, l: 50 }, // Green
    { h: 35, s: 70, l: 60 },  // Orange
    { h: 330, s: 60, l: 65 }, // Pink
    { h: 200, s: 55, l: 58 }, // Cyan
  ];
      ...
      style={
        {
          ...
          "--width": `${width}`,
          "--aspect-ratio": `${ar}`,
          "--background": `linear-gradient(hsl(${color.h} ${color.s}% ${color.l}%), transparent)`,
...
export const WarpBackground: React.FC<WarpBackgroundProps> = ({
  ...
  beamDelayMin = 0,
  beamDuration = 3,
  gridColor = "hsl(30 15% 85%)", // Beige/tan grid color
  ...props
}) => {
